...
with col2:
    ...
    st_toggle_switch(label="Show Face Mesh", key="toggle_switch", default_value=False, label_after=False, inactive_color="#FAFAFA", active_color="#FCBC24", track_color="#03A9F2")
